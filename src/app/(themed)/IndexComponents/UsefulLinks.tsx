...
const LINK_IMAGES = {
  sectionQuran: unsplashImage('photo-1761406778100-de0254ec6788'),
...
const categories: Category[] = [
  ...
  },
  {
    ...
    bgImage: LINK_IMAGES.sectionQuran,
    links: [
      {
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-3">
              {selectedCategory.links.map(link => (
                ...
                >
                  ...
                  />
                  <span className="absolute inset-0 bg-[linear-gradient(135deg,rgba(0,0,0,0.34),rgba(21,49,71,0.24)_42%,rgba(0,0,0,0.82))]" />
